...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "Esnet"; //Local Storage Names for PWA
        ...
        if (locationBut.length) {
            ...
            if (typeof(locationSupport) != 'undefined' && locationSupport != null) {
                ...
                if ("geolocation" in navigator) {
                    ...
                    locationSupport.innerHTML = 'Your browser and device <strong class="color-red2-dark">do not support</strong> Geolocation.';
                }
            }
            ...
            function geoLocate() {
                ...
                function success(position) {
                    ...
                    locationCoordinates.innerHTML = '<strong>Longitude:</strong> ' + longitude + ' <strong> Latitude:</strong> ' + latitude;
        
                    var mapLinkNewAPI = 'https://www.google.com/maps/@' + latitude + ',' + longitude + ',15z';
                    var locationButton = document.getElementsByClassName('location-button')[0];
                    locationButton.setAttribute('href', mapLinkNewAPI);
                    locationButton.setAttribute('target', '_blank'); // Open in new window
                    locationButton.classList.remove('disabled');
                }
        
                function error() {
                    locationCoordinates.textContent = 'Não foi possível obter sua localização';
                }
        
                if (!navigator.geolocation) {
                    locationCoordinates.textContent = 'Geolocalização não suportada pelo seu navegador!';
                } else {
